...
class DenoiseDiffusion:
    ...
    def __init__(self, n_steps: int, device_n: torch.device):
        """
        Params:
        ...
        self.beta = torch.linspace(0.0001, 0.02, n_steps).to(device_n)
    ...
    def p_sample(self, xt: torch.Tensor, eps_theta: torch.Tensor,t: torch.Tensor):
        """
